    ...
    return (
        <Room>
            <Stack.Navigator>
                ...
                <Stack.Screen name="ConstructorMainInfo" component={Constructor_MainInfoScreen}
                              options={slideAnimation}/>
                <Stack.Screen name="ConstructorParams" component={Constructor_ParamsScreen} options={slideAnimation}/>
                <Stack.Screen name="ConstructorQuestion" component={Constructor_QuestionScreen}
                              options={slideAnimation}/>
                <Stack.Screen name="Settings" component={ProfileRoom_SettingsScreen} back={true}
                              options={slideAnimation}/>
